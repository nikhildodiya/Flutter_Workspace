...
class CreditCardEdit extends StatefulWidget
{
  ...
  CreditCardEdit({required this.data});
...
class _CreditCardEditState extends State<CreditCardEdit>
{
  ...
  {
    super.initState();
    selectedBank = widget.data['selectedBank'];
    Holder_Name.text = widget.data['Holder_Name'];
    Card_Number.text = widget.data['Card_Number'];
    CVV.text = widget.data['CVV'];
            ...
            [
              ...
              ElevatedButton(
                ...
                onPressed: () async
                {
                  ...
                  {
                    var url = Uri.parse(
                        "https://nikhil2293.000webhostapp.com/API/Handler/handlerCreditCardUpdate.php");
