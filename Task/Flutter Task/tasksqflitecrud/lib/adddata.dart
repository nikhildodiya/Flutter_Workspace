              ...
              children: [
                ...
                ElevatedButton(onPressed: ()
                  ...
                  if (_formKey.currentState!.validate() &&
                      ...
                      isGenderSelected())
                    {
                      mydb.db.rawInsert("INSERT INTO students (first_name,last_name,mobile,email,hobbies,gender,city,password,confirm_password) values(?,?,?,?,?,?,?,?,?)",
                        [FirstName.text.toString(),LastName.text.toString(),Mobile.text.toString(),
                          Email.text.toString(),selectedHobbies.toString(),selectedGender.toString(),
